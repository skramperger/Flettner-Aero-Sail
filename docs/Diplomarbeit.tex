...
\newacronym{i2c}{I\textsuperscript{2}C}{Zweidraht-Bus für Display und Sensoren}
...
\newacronym{fmd}{FDM}{Fused Deposition Modeling – Schmelzschichtverfahren}
...
% Bild von https://thepihut.com/blogs/raspberry-pi-tutorials/how-to-use-a-rotary-encoder-with-the-raspberry-pi
% Bild von https://www.switchelectronics.co.uk/products/dual-axis-joystick-module
\begin{figure}[H]
    \centering
...
\noindent\rule{\linewidth}{0.4pt}  % top stripe
\lstinputlisting[
]{codesnippets/controller/sendControlData.cpp}

\lstinputlisting[
  caption={Sende- und Empfangsfunktion},
...
% globale Objekte (boat)
\noindent\rule{\linewidth}{0.4pt}  % top stripe
\lstinputlisting[
  caption={Sende- und Empfangsfunktion},
  label={lst:listing18-cpp}
]{codesnippets/boat/globale_objekte.cpp}
\noindent\rule{\linewidth}{0.4pt}  % bottom stripe



% globale Objekte (controller)


% configuration constants (boat)
\noindent\rule{\linewidth}{0.4pt}  % top stripe
\lstinputlisting[
  caption={Sende- und Empfangsfunktion},
...
% configuration constants (controller)
\noindent\rule{\linewidth}{0.4pt}  % top stripe
\lstinputlisting[
  caption={Sende- und Empfangsfunktion},
...
\subsection{Zeitlicher Fortschritt}
\label{sec:zeitplan}

\noindent
Der zeitliche Ablauf des Projekts ist in Tabelle \ref{tab:timeline} dargestellt.  
...
\date{11.\,09.\,2024} & 
\begin{tabular}[t]{@{}l@{}}
Berechnung und Festlegung der ersten Schritte für die Umsetzung \\[-0.4em] des Projekts
\end{tabular} \\
\hline
\date{18.\,09.\,2024} & 
\begin{tabular}[t]{@{}l@{}}
...
\date{25.\,09.\,2024} & 
\begin{tabular}[t]{@{}l@{}}
Motordrehzahl überprüft und allgemeine Größen für den Rotor 
\\[-0.4em]festgelegt
\end{tabular} \\
\hline
\date{02.\,10.\,2024} & 
...
\date{16.\,10.\,2024} & 
\begin{tabular}[t]{@{}l@{}}
Experimenteller Versuch mit einem Rotor, einem DC-Motor 
\\[-0.4em]und einem Standventilator
\end{tabular} \\
\hline
\date{23.\,10.\,2024} & 
\begin{tabular}[t]{@{}l@{}}
...
\newpage
% for bibliography
\bibliographystyle{plain}     % You can also use: ieeetr, abbrv, alpha...
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Batteriehalter.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Brushless DC Motor.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.44\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Dichtmasse.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Dichtung Elektronikbox.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Einschmelzgewinde.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Flanschverbinder.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Führungsstange.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Gummidichtung Servo.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Kippschalter Boot.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Kippschalter Controller.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Kleber.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Kugellager.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Ruder.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Zahnriemen.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Servo und Gestänge.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Zahnriemenscheiben.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung 40AESC.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung ESP32 Breakout Board.pdf}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung Drehgeber.pdf}
    ...
    \begin{minipage}[b]{0.42\linewidth}
        \centering
        \includegraphics[width=\linewidth]{images/Rechnungen/Rechnung I2C Display.pdf}
